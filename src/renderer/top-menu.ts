...
export class TopMenu {
  ...
  setUpdateStatus(available: boolean, version: string | null): void {
  ...
  private render(): void {
    this.el.innerHTML = `
      ...
      <div class="top-menu-body">
        ...
        <button type="button" class="top-menu-item top-menu-item-update" data-action="update-omp">
          ...
          <span class="top-menu-label">Update OMP</span>
          ${this.latestVersion ? `<span class="top-menu-badge">${this.latestVersion}</span>` : ""}
        </button>
    ...
    this.el.querySelector('[data-action="update-omp"]')?.addEventListener("click", () => {
      this.close();
      this.callbacks.onUpdateOmp?.();
    });
