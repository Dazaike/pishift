...
const api = {
  ...
  exportSettings: (): Promise<ExportSettingsResult> => ipcRenderer.invoke(CH.exportSettings),
  importSettings: (): Promise<ImportSettingsResult> => ipcRenderer.invoke(CH.importSettings),
